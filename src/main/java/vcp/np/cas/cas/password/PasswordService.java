...
import vcp.np.cas.services.email.CustomMailSender;
...
public class PasswordService {
	...
	public Map<String, Object> resetPassword(Claims claims, Long clientServiceId, String rawPassword) throws Exception {
    	...
    	if (!plainSqlQueries.isUserPasswordUpdated(userClientService.getUser(), newPasswordDetails, passwordResetTimeStamp)) {
