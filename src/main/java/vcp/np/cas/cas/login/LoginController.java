            ...
            if ((boolean) loginData.getOrDefault(Constants.IS_LOGIN_SUCCESSFUL, false)) {
            	...
            	if (redirectionUrl == null || redirectionUrl.isEmpty()) {
            		...
            		redirectionUrl = redirectionUrl 
						+ ((String) loginData.getOrDefault(Constants.LOGIN_SUCCESS_PATH, ""))
						+ "?" + Constants.HOST_URL + "=" + hostUrl
						+ "&token=" + ((String) loginData.getOrDefault(Constants.JwtToken.KEY, ""));
            	}
            	
				System.out.println("Login success redirecting to url: " + redirectionUrl);
